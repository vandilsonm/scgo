 ...
 * @author Nathalia
 */
public class ServletInsereCampeonato extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            campeonato.setDescricao(request.getParameter("descricao"));
            campeonato.setTipo("P");
            campeonato.setTabela("M");

            TOUsuario usuario = new TOUsuario();
            HttpSession session = request.getSession();

            usuario.setCodigo(Integer.parseInt(session.getAttribute("usuario").toString()));
            campeonato.setAdministrador(usuario);

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            ...
            <div id="header">
                ...
                <div id="header_submenu">
                    <ul class="breadcrumb">
                        ...
                        <li>&raquo;</li>
                        <li><a href="arbitragem.jsp" title="Arbitragem">Arbitragem</a></li>
                    </ul>
                </div>
                ...
                <div id="container_one_text">
                    ...
                    <div id="links_moldura">
                        <div id="adm_container_one_text">
                            ...
                            <h2>Gerenciando: <span class="corDestaque">Meus Campeonatos</span> // <span class="corDestaque">Arbitragem</span></h2>
                            <fieldset>
        ...
        <script type="text/javascript" src="js/arbitragem.js"></script>
    </body>
</html>
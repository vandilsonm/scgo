...
Estadio.Load = function(){
    var _dados = new Estadio();
    _dados.initialize();
    return _dados;
}
...
Estadio.prototype = {
    ...
    initialize: function() {
        ...
        this.executeBind('../ServletListaEstadio', '', 'GET', this._sucessoLoadLista);
    ...
    _sucessoLoadLista: function(value) {
        ...
        for (var i = 0; i < listaEstadio.length; i++ ) {
            html = "";
            html += "<tr><td>" + listaEstadio[i].nome + "</td>";
    ...
    _alterarOnSuccess: function(value) {
        ...
        this.executeBind('../ServletListaUmEstadio', str, 'GET', this._alterarLoadOnSuccess);
    },
    ...
    _excluirItemOnClick: function (value) {
        if (confirm("Deseja excluir o registro?")) {
            ...
            this.executeBind('../ServletExcluiEstadio', str, 'GET', this._cadastroOnSuccess);
        }
    },
    ...
    _btnCadastroOnClick: function(value) {
        if ($('#txtNome').val() == '') {
            ...
            this.executeBind('../ServletInsereEstadio', str, 'GET', this._cadastroOnSuccess);
        }
    },
    ...
    _btnCadastroAltOnClick: function (value) {
        if ($('#txtNome').val() == '') {
            ...
            this.executeBind('../ServletAlteraEstadio', str, 'GET', this._cadastroOnSuccess);
        }
    },

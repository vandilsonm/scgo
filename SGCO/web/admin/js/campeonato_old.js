...
//        var html = "<fieldset><span class=\"legend\">Campeonato(s) Cadastrado(s)</span>";
//        html += "<table width=\"540\" border=\"1\" cellspacing=\"2\" cellpadding=\"2\" "
//        html += "class=\"gridListagem\">";
        var html = "<tr><th>Nome</th><th>Tipo</th>"
...
//        $('#adm_container_one_text_form').html(html);
    ...
    _alterarLoadOnSuccess: function(value) {
        ...
        $('#ddlTabela').attr("value", dados.tabela);
    },

...
<h1>Cadastre-se no GOLAÇO</h1>
<p>Faça já o seu cadastro para que o seu campeonato possa ser conhecido por todos!</p>
<div id="container_one_text_form">
<fieldset>
...
<input id="btnCadastro" type="button" value="Efetuar cadastro" class="botao" />
</fieldset>
</div>
</div>
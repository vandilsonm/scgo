...
import br.una.sgco.peladinha.bo.BOConfirmacao;
 ...
 * @author Jana Louback
 */
public class ServletInserirConfirmacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            TOConfirmacao toConfirmacao = new TOConfirmacao();
            toConfirmacao.setConfirmacao(Boolean.parseBoolean(request.getParameter("confirmacao")));

            TOPelada toPelada = new TOPelada();
            toPelada.setId(Integer.parseInt(request.getParameter("idPelada").toString()));
            toConfirmacao.setIdPelada(toPelada);
            ...
            BOConfirmacao.inserir(toConfirmacao);

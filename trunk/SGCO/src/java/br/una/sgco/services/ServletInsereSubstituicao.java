 ...
 * @author Nathalia
 */
public class ServletInsereSubstituicao extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            jogadorEntrou.setCodigo(Integer.parseInt(request.getParameter("jogadorEntrou")));

            TOJogador jogadorSaiu = new TOJogador();
            jogadorSaiu.setCodigo(Integer.parseInt(request.getParameter("jogadorSaiu")));

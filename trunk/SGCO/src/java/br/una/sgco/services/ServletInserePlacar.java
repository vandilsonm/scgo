...
import br.una.sgco.bo.BOPlacar;
 ...
 * @author Nathalia
 */
public class ServletInserePlacar extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            placar.setJogo(jogo);
            placar.setTime(time);
            placar.setJogador(jogador);
            placar.setQtdeGols(Integer.parseInt(request.getParameter("qtdeGols")));

            BOPlacar.inserir(placar);

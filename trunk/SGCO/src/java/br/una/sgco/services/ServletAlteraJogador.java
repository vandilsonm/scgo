 ...
 * @author Nathalia
 */
public class ServletAlteraJogador extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            jogador.setCodigo(Integer.parseInt(request.getParameter("id")));
            ...
            jogador.setTwitter(request.getParameter("twitter"));
            jogador.setStatus("A");

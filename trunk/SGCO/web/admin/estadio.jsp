...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                ...
                <div id="container_one_text">
                    ...
                    <div id="links_moldura">
                        <div id="adm_container_one_text">
                            ...
                            <h2>Gerenciando: <span class="corDestaque">Meus Campeonatos</span> // <span class="corDestaque">Estádio</span></h2>
                            <fieldset>
        ...
        <script type="text/javascript" src="js/estadio.js"></script>
    </body>
</html>
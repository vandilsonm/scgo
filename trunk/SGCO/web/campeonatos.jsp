...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Lista de Campeonatos - GOLAÇO</title>
    ...
    <body>
            ...
            <div id="header">
                ...
                <div id="header_menu">
                    <ul>
                        ...
                        <li><a href="campeonatos.jsp" class="selecionado" title="Veja nossa lista de campeonatos ativos">Campeonatos</a></li>
        ...
        <script type="text/javascript" src="js/campeonatos.js"></script>
    </body>
</html>